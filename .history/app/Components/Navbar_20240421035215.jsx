...
function Navbar() {
  return (
    ...
    <nav id='navBarContainer' >
      ...
      <a id='navbarDexScreenerLink' style={{cursor: 'pointer', outline: '4px solid lime'}}  href='https://dexscreener.com/base/0xd109457ac2d85f428a98addf6e1c7ec898976405' target="_blank">
